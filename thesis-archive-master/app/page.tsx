...
export default function Home() {
  return (
    <div className="space-y-12">
      ...
      <section className="grid gap-6 rounded-3xl border border-border/60 bg-gradient-to-br from-[#704040]/40 via-[#8A4C4C]/30 to-[#3B1E1E]/80 p-6 shadow-sm md:grid-cols-2">
