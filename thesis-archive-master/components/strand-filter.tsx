...
const strands: Array<{
  ...
  },
  {
    key: "STEM",
    label: "STEM Theses",
    description: "Scientific, exploratory, logical.",
  ...
  },
  {
    key: "PBM",
    label: "PBM Theses",
    description: "Ocean-focused, skilled, operational.",
    Icon: BuildingOffice2Icon,
    href: "/pbm",
  },
  {
    key: "HUMSS",
    label: "HUMSS Theses",
    description: "Social, reflective, communicative.",
    Icon: BuildingOffice2Icon,
    href: "/humss",
  },
  {
    key: "EIM",
    label: "EIM Theses",
    description: " Electrical, mechanical, technical.",
    Icon: BuildingOffice2Icon,
    href: "/eim",
  },
   {
    key: "HE",
    label: "EIM Theses",
    description: "Practical, service-oriented, creative.",
    Icon: BuildingOffice2Icon,
    href: "/he",
  },
   {
    key: "SMAW",
    label: "SMAW Theses",
    description: "Metalworking, skilled, hands-on.",
    Icon: BuildingOffice2Icon,
    href: "/smaw",
  },
];
